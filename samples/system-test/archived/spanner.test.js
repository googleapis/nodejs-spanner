...
const schemaCmd = 'node archived/schema.js';
...
const backupsCmd = 'node archived/backups.js';
const instanceCmd = 'node archived/instance.js';
const createTableWithForeignKeyDeleteCascadeCommand =
  'node archived/table-create-with-foreign-key-delete-cascade.js';
const alterTableWithForeignKeyDeleteCascadeCommand =
  'node archived/table-alter-with-foreign-key-delete-cascade.js';
const dropForeignKeyConstraintDeleteCascaseCommand =
  'node archived/table-drop-foreign-key-constraint-delete-cascade.js';
