  ...
  namespace spanner {
    ...
    namespace music {
      ...
      class SingerInfo implements ISingerInfo {
         ...
         */
        public static create(properties?: examples.spanner.music.ISingerInfo): examples.spanner.music.SingerInfo;
         ...
         * @returns Writer
         */
        public static encode(message: examples.spanner.music.ISingerInfo, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: examples.spanner.music.ISingerInfo, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): examples.spanner.music.SingerInfo;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): examples.spanner.music.SingerInfo;
         ...
         * @returns SingerInfo
         */
        public static fromObject(object: { [k: string]: any }): examples.spanner.music.SingerInfo;
         ...
         */
        public static toObject(message: examples.spanner.music.SingerInfo, options?: $protobuf.IConversionOptions): { [k: string]: any };
