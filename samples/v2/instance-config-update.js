...
function main(
  ...
  async function updateInstanceConfig() {
    ...
    const instanceConfig = instanceAdminClient.updateInstanceConfig({
        instanceConfig: {
            name: instanceConfigId,
        },
        updateMask: await instanceAdminClient.getInstanceConfig({
...
/* not getting how to add update mask field */
