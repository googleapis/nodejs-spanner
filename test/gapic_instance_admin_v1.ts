...
describe('v1.InstanceAdminClient', () => {
    ...
    describe('getInstanceConfig', () => {
        it('invokes getInstanceConfig without error', async () => {
            ...
            assert((client.innerApiCalls.getInstanceConfig as SinonStub)
        ...
        it('invokes getInstanceConfig with error', async () => {
            ...
            await assert.rejects(async () => { await client.getInstanceConfig(request); }, expectedError);
            assert((client.innerApiCalls.getInstanceConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getInstance', () => {
        ...
        it('invokes getInstance with error', async () => {
            ...
            await assert.rejects(async () => { await client.getInstance(request); }, expectedError);
            assert((client.innerApiCalls.getInstance as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteInstance', () => {
        ...
        it('invokes deleteInstance with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteInstance(request); }, expectedError);
            assert((client.innerApiCalls.deleteInstance as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createInstance', () => {
        ...
        it('invokes createInstance with call error', async () => {
            ...
            await assert.rejects(async () => { await client.createInstance(request); }, expectedError);
            assert((client.innerApiCalls.createInstance as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateInstance', () => {
        ...
        it('invokes updateInstance with call error', async () => {
            ...
            await assert.rejects(async () => { await client.updateInstance(request); }, expectedError);
            assert((client.innerApiCalls.updateInstance as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listInstanceConfigs', () => {
        it('invokes listInstanceConfigs without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listInstanceConfigs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listInstanceConfigs with error', async () => {
            ...
            await assert.rejects(async () => { await client.listInstanceConfigs(request); }, expectedError);
            assert((client.innerApiCalls.listInstanceConfigs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listInstances', () => {
        ...
        it('invokes listInstances with error', async () => {
            ...
            await assert.rejects(async () => { await client.listInstances(request); }, expectedError);
            assert((client.innerApiCalls.listInstances as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
