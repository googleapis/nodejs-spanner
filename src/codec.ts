...
export interface IProtoMessageParams {
  ...
  // and serializing messages. Method to serialize (i.e. "encode") should be
  // present when writing data and method to deserialize (i.e. "decode") should
  // be present while reading/querying data.
  // User needs to pass typings/js generated by protobufjs.
...
export interface IProtoEnumParams {
  ...
  // fully qualified name of the proto representing the enum definition
  fullName: string;
  // Object containing enum string to id mappings.
  // Users can use it from typings/js generated by protobufjs.
  enumObject?: object;
}
 ...
 * @param {Function | object} [columnInfo] Additional parameter which
 * may help in deserialize data coming from backend.
 * @returns {*}
 */
function decode(
  value: Value,
