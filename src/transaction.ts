...
export class Snapshot extends EventEmitter {
  ...
  begin(
    ...
    return startTrace('Transaction.begin', {}, span => {
      const gaxOpts =
  ...
  read(
    ...
    return startTrace('Transaction.read', {tableName: table}, span => {
      const rows: Rows = [];
  ...
  run(
    ...
    return startTrace('Transaction.run', {sql: query}, span => {
      const rows: Rows = [];
  ...
  runStream(query: string | ExecuteSqlRequest): PartialResultStream {
    ...
    return startTrace('Transaction.runStream', query, span => {
...
export class Dml extends Snapshot {
  ...
  runUpdate(
    ...
    return startTrace('Transaction.runUpdate', query, span => {
      this.run(
        query,
        (
          err: null | grpc.ServiceError,
...
export class Transaction extends Dml {
  ...
  batchUpdate(
    ...
    return startTrace('Transaction.batchUpdate', {}, span => {
      const options =
  ...
  commit(
    ...
    return startTrace('Transaction.commit', {}, span => {
      const options =
        typeof optionsOrCallback === 'object' ? optionsOrCallback : {};
      const callback =
        typeof optionsOrCallback === 'function' ? optionsOrCallback : cb!;
  ...
  rollback(
    ...
    return startTrace('Transaction.rollback', {}, span => {
      const gaxOpts =
        typeof gaxOptionsOrCallback === 'object' ? gaxOptionsOrCallback : {};
      const callback =
        typeof gaxOptionsOrCallback === 'function' ? gaxOptionsOrCallback : cb!;
