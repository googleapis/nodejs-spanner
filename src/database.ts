...
class Database extends common.GrpcServiceObject {
  ...
  batchCreateSessions(
    ...
    return startTrace('Database.batchCreateSessions', q, span => {
  ...
  createSession(
    ...
    const q = {opts: this.observabilityConfig};
    return startTrace('Database.createSession', q, span => {
      const headers = this.resourceHeader_;
      if (this._getSpanner().routeToLeaderEnabled) {
        addLeaderAwareRoutingHeader(headers);
      }
  ...
  createTable(
    ...
    const q = {opts: this.observabilityConfig};
    return startTrace('Database.createTable', q, span => {
  ...
  delete(
    ...
    const q = {opts: this.observabilityConfig};
    return startTrace('Database.delete', q, span => {
      this.close(() => {
  ...
  get(
    ...
    const callback =
      typeof optionsOrCallback === 'function' ? optionsOrCallback : cb;
    const q = {opts: this.observabilityConfig};
    return startTrace('Database.get', q, span => {
  ...
  getMetadata(
    ...
    const q = {opts: this.observabilityConfig};
    return startTrace('Database.getMetadata', q, span => {
      return this.request(
        {
          client: 'DatabaseAdminClient',
          method: 'getDatabase',
  ...
  getSchema(
    ...
    const q = {opts: this.observabilityConfig};
    return startTrace('Database.getSchema', q, span => {
  ...
  getIamPolicy(
    ...
    const q = {opts: this.observabilityConfig};
    return startTrace('Database.getIamPolicy', q, span => {
  ...
  getDatabaseRoles(
    ...
    const q = {opts: this.observabilityConfig};
    return startTrace('Database.getDatabaseRoles', q, span => {
      this.request<
        IDatabaseRole,
  ...
  restore(
    ...
    const q = {opts: this.observabilityConfig};
    return startTrace('Database.restore', q, span => {
      return this.request(
        {
          client: 'DatabaseAdminClient',
  ...
  runPartitionedUpdate(
    ...
    const q = {sql: query, opts: this.observabilityConfig};
    return startTrace('Database.runPartitionedUpdate', q, span => {
      this.pool_.getSession((err, session) => {
        if (err) {
          span.end();
  ...
  _runPartitionedUpdate(
    ...
    const q = {sql: query, opts: this.observabilityConfig};
    return startTrace('Database._runPartitionedUpdate', q, span => {
  ...
  async runTransactionAsync<T = {}>(
    ...
    const q = {opts: this.observabilityConfig};
    return startTrace('Database.runTransactionAsync', q, async span => {
  ...
  batchWriteAtLeastOnce(
    ...
    const q = {opts: this.observabilityConfig};
    return startTrace('Database.batchWriteAtLeastOnce', q, span => {
      const proxyStream: Transform = through.obj();
