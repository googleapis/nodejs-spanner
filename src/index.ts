...
class Spanner extends GrpcService {
   ...
   * @property {object} value Proto Message Value. Serialized Buffer or message object.
   * @property {string} fullName Proto message Full Qualified Path Name.
   * @property {Function} [messageFunction] Function generated by protobufs which
   ...
   * @property {string | number} value Proto Enum Value. Enum String Constant
   * or Integer Constant.
   * @property {string} fullName Proto Enum Full Qualified Path Name.
   * @property {object} [enumObject] An object which have mapping from enum
   * string to integer constant. User can use it from typings/js generated by
   * protobufjs.
   */
  /**
