...
class Instance extends common.GrpcServiceObject {
  ...
  createDatabase(
    ...
    return startTrace('Instance.createDatabase', {}, span => {
      if (!name) {
  ...
  delete(
    ...
    return startTrace('Instance.delete', {}, span => {
      const gaxOpts =
  ...
  exists(
    ...
    return startTrace('Instance.exists', {}, span => {
      const gaxOptions =
        typeof optionsOrCallback === 'object' ? optionsOrCallback : {};
      const callback =
        typeof optionsOrCallback === 'function' ? optionsOrCallback : cb!;
  ...
  get(
    ...
    return startTrace('Instance.get', {}, span => {
      const callback =
        typeof optionsOrCallback === 'function' ? optionsOrCallback : cb!;
      const options =
        typeof optionsOrCallback === 'object'
      ...
      this.getMetadata(getMetadataOptions, (err, metadata) => {
        ...
        return startTrace('Instance.create', {}, createSpan => {
          this.create(
            createOptions,
            (
  ...
  getDatabases(
    ...
    return startTrace('Instance.getDatabases', {}, span => {
  ...
  getMetadata(
    ...
    return startTrace('Instance.getMetadata', {}, span => {
      const callback =
        typeof optionsOrCallback === 'function' ? optionsOrCallback : cb!;
      const options =
        typeof optionsOrCallback === 'object' ? optionsOrCallback : {};
  ...
  setMetadata(
    ...
    return startTrace('Instance.setMetadata', {}, span => {
      const gaxOpts =
        typeof optionsOrCallback === 'object' ? optionsOrCallback : {};
      const callback =
        typeof optionsOrCallback === 'function' ? optionsOrCallback : cb!;
