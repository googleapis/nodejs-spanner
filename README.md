...
| Gets the query statistics from the last hour for a specific tag | [source code](https://github.com/googleapis/nodejs-spanner/blob/master/samples/query-tag.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/googleapis/nodejs-spanner&page=editor&open_in_editor=samples/query-tag.js,samples/README.md) |
...
| Executes a read/write transaction with transaction and query tags | [source code](https://github.com/googleapis/nodejs-spanner/blob/master/samples/transaction-tag.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/googleapis/nodejs-spanner&page=editor&open_in_editor=samples/transaction-tag.js,samples/README.md) |
