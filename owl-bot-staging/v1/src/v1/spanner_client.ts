...
export class SpannerClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.descriptors.stream = {
      executeStreamingSql: new this._gaxModule.StreamDescriptor(gax.StreamType.SERVER_STREAMING, opts.fallback === 'rest'),
      streamingRead: new this._gaxModule.StreamDescriptor(gax.StreamType.SERVER_STREAMING, opts.fallback === 'rest')
    };
